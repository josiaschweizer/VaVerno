...
public class CourseScheduleLifecycleWidgetGroup extends VerticalLayout implements Refreshable {
  ...
  public CourseScheduleLifecycleWidgetGroup(@Nonnull final VernoServerGate vernoServerGate) {
    this.courseScheduleService = vernoServerGate.getService(ICourseScheduleService.class);
